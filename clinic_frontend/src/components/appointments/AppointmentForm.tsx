                  ...
                  <CommandList>
                    ...
                    <CommandGroup>
                      {patients.map((patient) => (
                        <CommandItem
                          key={patient.id}
                          value={`${patient.uhid} ${patient.user_name || `Patient #${patient.id}`} ${patient.user_phone || ''}`}
                          onSelect={() => {
                        ...
                        >
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-sm text-muted-foreground">
                              {GENDERS.find(g => g.value === patient.gender)?.label || 'Not set'} • {patient.user_phone || 'No phone'}
                            </span>
                          </div>
                        </CommandItem>
                      ))}
